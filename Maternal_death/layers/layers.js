...
maxResolution:28004.466152261964,
    ...
    <img src="styles/legend/TAMILNADU_DISTRICTS_1_0.png" /> 6 - 10.2<br />\
    <img src="styles/legend/TAMILNADU_DISTRICTS_1_1.png" /> 10.2 - 14<br />\
    <img src="styles/legend/TAMILNADU_DISTRICTS_1_2.png" /> 14 - 16<br />\
    <img src="styles/legend/TAMILNADU_DISTRICTS_1_3.png" /> 16 - 23.6<br />\
    <img src="styles/legend/TAMILNADU_DISTRICTS_1_4.png" /> 23.6 - 55<br />'
        });
...
lyr_TAMILNADU_DISTRICTS_1.set('fieldLabels', {'OBJECTID': 'hidden field', 'dtname': 'header label - visible with data', 'stname': 'header label - visible with data', 'stcode11': 'hidden field', 'dtcode11': 'hidden field', 'year_stat': 'hidden field', 'test': 'hidden field', 'Dist_LGD': 'hidden field', 'State_LGD': 'hidden field', 'Shape_Leng': 'hidden field', 'Shape_STAr': 'hidden field', 'Shape_STLe': 'hidden field', 'id': 'hidden field', 'finally_field_1': 'hidden field', 'finally_Data source': 'hidden field', 'finally_Infant Deaths': 'hidden field', 'finally_Maternal Deaths': 'header label - visible with data', 'finally_No of PHC\'s': 'hidden field', 'finally_Percentage who had four or more ANC  District visits': 'hidden field', 'finally_Percentage who had four or more ANC  District visits_1': 'hidden field', 'finally_Percentage of births delivered  in a public health facility': 'hidden field', 'finally_Percentage of births delivered in a private health facility': 'hidden field', 'finally_MCV/Measles/MMR/MR': 'hidden field', 'finally_All basic vaccinations': 'hidden field', 'finally_All age appropriate vaccinations': 'hidden field', 'finally_No vaccinations': 'hidden field', 'finally_Percentage of children having any anaemia  (<11.0 g/dl )': 'hidden field', 'finally_Percentage of women with BMI <18.5 (total thin)': 'hidden field', 'finally_Percentage of women with BMI >=25.0 (Overweight or obese)': 'hidden field', });
